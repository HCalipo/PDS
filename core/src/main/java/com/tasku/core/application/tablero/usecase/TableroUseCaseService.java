...
public class TableroUseCaseService {
    ...
    private void validateCreateBoardRequest(CreateBoardRequest request) {
        ...
        UseCaseValidator.requireText(request.name(), "El nombre del tablero es obligatorio");
        UseCaseValidator.requireText(request.color(), "El color del tablero es obligatorio");
        UseCaseValidator.requireText(request.description(), "La descripcion del tablero es obligatoria");
    }
}
